...
export default function DearAll() {
  ...
  const letterRef = useScrollReveal();
  const storyRef = useScrollReveal();

  return (
    <section className="intro-letter">
      <h2 ref={titleRef}>A NOTE OF THANKS</h2>

      <div ref={letterRef} className="letter-box">
        <div>
          <p>
      ...
      <div ref={storyRef} className="our-story">
        <ul className="our-story__list">
          <li className="our-story__item">
            <div className="our-story__photo-wrap">
              <img
                src={process.env.PUBLIC_URL + "/donghwan.jpg"}
                alt="김동환"
                draggable={false}
              />
            </div>

            <div className="our-story__name our-story__name--groom">
              신랑 <span>김동환</span>
            </div>
          </li>
          ...
          <li className="our-story__item">
            <div className="our-story__photo-wrap">
              <img
                src={process.env.PUBLIC_URL + "/jiyoun.jpg"}
                alt="강지윤"
                draggable={false}
              />
            </div>

            <div className="our-story__name our-story__name--bride">
              신부 <span>강지윤</span>
            </div>
          </li>
        </ul>
        ...
        <div className="our-story__meta" aria-live="polite">
          <span className="our-story__heart" aria-label="하트">
            ❤
          </span>
        </div>
      </div>
